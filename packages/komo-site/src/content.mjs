...
export const pages = [
 ...
 <section class="try-section" aria-labelledby="try-heading"><div class="try-heading-row"><h2 id="try-heading">You’re here. Leave a comment.</h2></div><button id="try-komo" class="try-block" data-try-komo aria-label="Say hi 👋 — add a comment"><span class="try-content"><span class="try-icon"><span data-icon="comment"></span></span><strong>Say hi 👋</strong><span class="try-caption">Click to leave a comment</span></span><span class="try-cursors" aria-hidden="true"><span class="try-cursor-track try-cursor-design"><span class="agent-cursor" data-agent="D"><span data-icon="multiplayer"></span><span data-cursor-name>Designer</span></span></span><span class="try-cursor-track try-cursor-code"><span class="agent-cursor" data-agent="E"><span data-icon="multiplayer"></span><span data-cursor-name>Engineer</span></span></span><span class="try-cursor-track try-cursor-qa"><span class="agent-cursor" data-agent="P"><span data-icon="multiplayer"></span><span data-cursor-name>PM</span></span></span></span></button><p>Public demo · Feedback stays during testing.</p></section>
`,
  },
  {
    path: "/install/",
