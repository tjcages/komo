...
`,
 ...
 ${section("When a project fills up", `<p>Existing feedback stays readable. In Account → Project settings, download your comments, then clear resolved threads to reclaim space. Export first: clearing threads is permanent. Owners can also delete a hosted project to free a project slot.</p>`)} `,
  },
  {
    path: "/agent-prompts/",
